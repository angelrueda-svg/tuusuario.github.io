 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "# Se POCSIONO LA TORTUGA EN LA POSICION INICIAL 0 Y AVANZA 50 UNIDADES DIBUJANDO SU RASTRO  \n",
    "# Posición inicial\n",
    "posicion = 0\n",
  ...
  },
  {
   ...
   "source": [
    "#Reto3. Girar y dibujar usando solo print e input.\n",
